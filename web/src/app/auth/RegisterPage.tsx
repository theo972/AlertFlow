...
import {registerRequest} from "../../lib/auth/auth-api.ts";
    ...
    const [error, setError] = useState<string | null>(null);
        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-slate-950 px-4">
                <div
                    className="w-full max-w-6xl bg-slate-950 rounded-3xl shadow-[0_20px_60px_rgba(0,0,0,0.7)] overflow-hidden flex flex-col lg:flex-row border border-slate-800">
                    <div className="w-full lg:w-1/2 px-10 py-10 flex flex-col justify-between bg-slate-950">
                        <div>
                            ...
                            <div className="mb-8">
                                <h1 className="text-3xl md:text-4xl font-bold text-slate-50 mb-2">Create an account</h1>
                                <p className="text-slate-400 text-sm md:text-base">Set up your credentials to access the dashboard.</p>
                            </div>
                    ...
                    <div
                        className="w-full lg:w-1/2 bg-gradient-to-br from-purple-500 via-indigo-500 to-pink-500 flex items-center justify-center p-8">
                        <div
                            className="w-full h-full max-h-[460px] rounded-3xl bg-white/5 border border-white/30 shadow-[0_20px_50px_rgba(0,0,0,0.4)] overflow-hidden flex items-center justify-center">
                            <img
